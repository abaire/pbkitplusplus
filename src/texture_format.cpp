...
const TextureFormatInfo &GetTextureFormatInfo(uint32_t nv_texture_format) {
  ...
  PBKPP_ASSERT(!"Unknown texture format.");
  return kInvalidTextureFormatInfo;
}

uint32_t TextureFormatForSurfaceFormat(uint32_t nv_surface_format, bool use_linear) {
  switch (nv_surface_format) {
    case NV097_SET_SURFACE_FORMAT_COLOR_LE_X1R5G5B5_Z1R5G5B5:
    case NV097_SET_SURFACE_FORMAT_COLOR_LE_X1R5G5B5_O1R5G5B5:
      return use_linear ? NV097_SET_TEXTURE_FORMAT_COLOR_LU_IMAGE_A1R5G5B5 : NV097_SET_TEXTURE_FORMAT_COLOR_SZ_A1R5G5B5;

    case NV097_SET_SURFACE_FORMAT_COLOR_LE_R5G6B5:
      return use_linear ? NV097_SET_TEXTURE_FORMAT_COLOR_LU_IMAGE_R5G6B5 : NV097_SET_TEXTURE_FORMAT_COLOR_SZ_R5G6B5;
    ...
    case NV097_SET_SURFACE_FORMAT_COLOR_LE_A8R8G8B8:
      return use_linear ? NV097_SET_TEXTURE_FORMAT_COLOR_LU_IMAGE_A8R8G8B8 : NV097_SET_TEXTURE_FORMAT_COLOR_SZ_A8R8G8B8;

    case NV097_SET_SURFACE_FORMAT_COLOR_LE_B8:
      return use_linear ? NV097_SET_TEXTURE_FORMAT_COLOR_LU_IMAGE_Y8 : NV097_SET_TEXTURE_FORMAT_COLOR_SZ_Y8;

    case NV097_SET_SURFACE_FORMAT_COLOR_LE_G8B8:
      return use_linear ? NV097_SET_TEXTURE_FORMAT_COLOR_LU_IMAGE_G8B8 : NV097_SET_TEXTURE_FORMAT_COLOR_SZ_G8B8;

    default:
      PBKPP_ASSERT(!"Unsupported surface format");
  }
}
