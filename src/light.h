...
class Light {
 public:
  virtual void Commit(NV2AState& host) const;

  /**
   * Sets up nv2a registers for this Light.
   * @param host NV2AState used to render this Light
   * @param look_direction Normalized forward vector of the camera
   */
  virtual void Commit(NV2AState& host, const XboxMath::vector_t& look_direction) const;
...
class Spotlight : public Light {
 ...
 public:
  ...
  void Commit(NV2AState& host) const override;
...
class DirectionalLight : public Light {
 public:
  ...
  void Commit(NV2AState& host, const XboxMath::vector_t& look_dir) const override;
