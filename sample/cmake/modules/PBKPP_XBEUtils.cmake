...
set(PBKPP_XBEUTILS_MODULE_PATH "${CMAKE_CURRENT_LIST_DIR}")
...
function(pbkpp_add_xbe)
    ...
    if (XBE_RESOURCE_DIRS)
        ...
        add_custom_target(
                ...
                COMMAND
                "${PBKPP_XBEUTILS_MODULE_PATH}/SyncResourceDirs.py"
                "${XBE_STAGING_DIR}"
