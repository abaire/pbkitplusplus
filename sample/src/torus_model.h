...
#ifndef _TORUS_MODEL_H_
#define _TORUS_MODEL_H_
...
class TorusModel : public PBKitPlusPlus::SolidColorModelBuilder {
 public:
  TorusModel() : SolidColorModelBuilder() {}
  TorusModel(const vector_t &diffuse, const vector_t &specular) : SolidColorModelBuilder(diffuse, specular) {}
  TorusModel(const vector_t &diffuse, const vector_t &specular, const vector_t &back_diffuse,
